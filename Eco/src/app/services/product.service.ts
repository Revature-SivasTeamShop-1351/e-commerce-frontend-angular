...
export class ProductService {
  ...
  create(payload: Product) {
    return this.httpClient.post<Product>('http://localhost:8080/admin', payload);
  }
  update(payload: Product){
    return this.httpClient.put(`http://localhost:8080/admin/${payload.id}`,payload);
  }
  delete(id:number){
    return this.httpClient.delete<Product>(`http://localhost:8080/admin/${id}`);
 }
}
